## pal_gazebo_plugins (humble) - 4.1.1-1

The packages in the `pal_gazebo_plugins` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pal_gazebo_plugins -y` on `Fri, 31 Oct 2025 07:29:30 -0000`
...
## pal_gazebo_plugins (humble) - 4.1.0-1
